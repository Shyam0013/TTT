...
function displayItems(){
    ...
    biryaniData.map(item=>{
        ...
        heart.innerHTML="Add";
        heart.style.padding = '8px 12px';
        heart.style.backgroundColor = 'indianred';
        ...
        itemName.style.fontFamily ="Open Sans";
        ...
        itemPrice.style.fontFamily ="Open Sans";
...
function cartItems(){
    ...
    cartData.map(item=> {
        ...
        rowData1.style.fontFamily="Arial";
        rowData1.style.fontSize="16px";
